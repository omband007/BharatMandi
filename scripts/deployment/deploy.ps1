...
$EC2_KEY = "scripts/deployment/test-key.pem"
...
Write-Host "View logs with: ssh -i scripts/deployment/test-key.pem ubuntu@13.236.3.139 pm2 logs bharat-mandi" -ForegroundColor Cyan
